<template>
  ...
  <el-container class="login-container">
        ...
        <div class="login-main">
          ...
          <div style="position:relative;">
            ...
            <el-row :gutter="10">
              ...
              <el-col :span="12">
                <el-button type="warning" style="width:100%;margin-bottom:30px;" @click.native.prevent="studentRegister">学生注册</el-button>
              </el-col>
    ...
    <el-footer style="background: #ffffff; text-align: center; line-height: 50px;font-size: 14px" height="50px">
      <a href="https://lp.yfhl.net" target="_blank" style="margin-left: 10px">作业管理系统</a>
    </el-footer>
